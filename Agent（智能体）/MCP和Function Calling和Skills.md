...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Z6bicxIx5naL8w6rChibB6YgLMeWnrMHv46m2b02uiayjNmGGmZ3fwVNhUz0ZiamEribwz68H1ZickuC2rUAhjG5hzog/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=1)
...
![[../Pictures/Pasted image 20260314161722.png]]
...
![[../Pictures/Pasted image 20260314161741.png]]
...
![[../Pictures/Pasted image 20260314162037.png]]
...
5) 项目目录，运行 make ui-deploy6) git 提交 branch到origin7) git 打包 tag名字与pom的版本号一致，先删除远程tag（如果存在）：git push upstream :refs/tags/v{版本号}，然后上传tag到 upstream (上传之前请先用git remote 看一下upstream是哪里，确认是spring-ai-alibaba/JManus)
```
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Z6bicxIx5naL8w6rChibB6YgLMeWnrMHv4WSYNh1jwRsia4TQwvftWAO3qFdRCFHowPuNB6gI3RxX3O6iaYch1lw7Q/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=2)
